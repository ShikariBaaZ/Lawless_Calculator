...
START_TEXT = """
Hello {}, I am Telegram [Lawless_Calculator](https://Github.com/ShikariBaaZ/Lawless_Calculator).

▷ Send me /calculator and See my Magic.

Made with by ❤️ [@The_Shikarii]
"""
START_BUTTONS = InlineKeyboardMarkup(
        [[
        InlineKeyboardButton('🔥 Source Code', url='https://github.com/ShikariBaaZ/Lawless_Calculator'),
        InlineKeyboardButton('Channel 📢', url='https://t.me/The_SHIKARI_Network')
        ]]
    )
CALCULATE_TEXT = "▷ Made by @The_Shikarii"
